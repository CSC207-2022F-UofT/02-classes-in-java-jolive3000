...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two strings as arguments and concatenates them in the order given
     *
     * @param first_string The first part of the name of this Silly instance
     * @param second_string The second part of the name of this Silly instance
     */
